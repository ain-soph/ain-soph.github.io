...
\begin{enumerate}[labelsep=15pt, parsep=-4pt]
    ...
    \item Watch the Watcher! Backdoor Attacks on Security-Enhancing Diffusion Models,\\
    C. Li, \textbf{R. Pang}, B. Cao, J. Chen, F. Ma, S. Ji, and T. Wang,\\
    Proceedings of {\it the USENIX Security Symposium\/} (\textbf{USENIX}), 2025.
